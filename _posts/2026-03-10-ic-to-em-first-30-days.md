...
In my first 30 days:
- Two engineers communicate in ways that create unclear module ownership. Result: duplicated code, inconsistent patterns. This is an architecture problem and a communication problem simultaneously.
- No one is sure who makes the final call on API contract decisions. Result: delays on every integration. This is a process problem and an architecture problem about where decisions live.
